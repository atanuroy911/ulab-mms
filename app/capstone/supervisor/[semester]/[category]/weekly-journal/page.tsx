...
export default function WeeklyJournalPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <AppHeader
        title={`${semester} - ${category} - Weekly Journal Marks`}
        subtitle={`Submit weekly journal marks for ${category} students`}
        gradient="blue"
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              size="sm"
                              onClick={() => router.push(`/capstone/supervisor/${semester}/${category}/weekly-journal/group/${group._id}`)}
                              className="ml-2"
                            >
                              Submit Marks
                            </Button>
