...
interface AggregateMarksModalProps {
  ...
  weightage: number;
  /** Final aggregated value out of `weightage` (already computed by getAggregatedMark/getProjectAggregatedMark). */
  aggregatedValue: number | null;
}

const METHOD_EXPLANATION: Record<'average' | 'best' | 'sum', string> = {
