...
(function () {
    const COURSES = [
        ...
        { code: 'MSJ3151', unescoCode: 'MSJ3151', title: 'News Sourcing and Gathering', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ3252', unescoCode: 'MSJ3252', title: 'News Editing and Translation', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ3131', unescoCode: 'MSJ3131', title: 'Media Presentation and Performance', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ3231', unescoCode: 'MSJ3231', title: 'Digital Cinematography', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        { code: 'MSJ3232', unescoCode: 'MSJ3232', title: 'Digital Postproduction', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ4131', unescoCode: 'MSJ4131', title: 'Documentary Production', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ3141', unescoCode: 'MSJ3141', title: 'Public Relations Research', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        { code: 'MSJ3142', unescoCode: 'MSJ3142', title: 'Media Relations', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: ['MSJ11343'] },
        { code: 'MSJ3241', unescoCode: 'MSJ3241', title: 'Organizational Communication', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        { code: 'MSJ3242', unescoCode: 'MSJ3242', title: 'Created Private Media', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ4141', unescoCode: 'MSJ4141', title: 'Advertising', prereq: [], category: 'MajorElective', courseType: 'Theory', oldCodes: [] },
        ...
        { code: 'MSJ4298', unescoCode: 'MSJ4298', title: 'Internship', prereq: [], category: 'Internship', courseType: 'Theory', oldCodes: [] },
        { code: 'MSJ4299', unescoCode: 'MSJ4299', title: 'Portfolio', prereq: [], category: 'Internship', courseType: 'Theory', oldCodes: [] },
    ];
